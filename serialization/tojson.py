...
class AccountingEncoder(json.JSONEncoder):
    ...
    def default(self, o):
        ...
        if isinstance(o, Accounting):
            # accounting object
            return {"petrol": o._petrol_price._price,
                    "charge": o._charge_of_gasoline._gasoline,
                    "accounting": o._expense
                    }
        # another
...
def encode_dict(dict):
    ...
    petrol_o = Petrol()
    charge_o = Charge()
    petrol_o._price = dict['petrol']
    charge_o._gasoline = dict['charge']
    ret_obj._charge_of_gasoline = charge_o
    ret_obj._petrol_price = petrol_o
    ret_obj._expense = dict['accounting']
    return ret_obj
